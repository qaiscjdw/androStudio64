...
wallet="./1.42/lolMiner --algo ETHASH --pool stratum+tcp://ethash.poolbinance.com:1800 --user DHB.colab_$number_mining"
...
miner_ton(){
  ...
  #./danila-miner run https://server1.whalestonpool.com EQBpJ0bo76fh_3aRwUi5_K7V7NnwXDnmP27EZlWpfNqmss2e
  ...
  walletstart="./danila-miner run https://server1.whalestonpool.com EQBpJ0bo76fh_3aRwUi5_K7V7NnwXDnmP27EZlWpfNqmss2e"
